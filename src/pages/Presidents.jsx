...
import keikoImg from "../assets/images/keiko.jpg";
import castilloImg from "../assets/images/castillo.jpg";
import desotoImg from "../assets/images/desoto.jpg";
...
export default function Presidents() {
  ...
  const [options, setOptions] = useState([
    { id: 1, name: "Keiko Fujimori", party: "Fuerza Popular", image: keikoImg, votes: 0 },
    { id: 2, name: "Pedro Castillo", party: "Perú Libre", image: castilloImg, votes: 0 },
    { id: 3, name: "Hernando de Soto", party: "Avanza País", image: desotoImg, votes: 0 },
  ]);

  const [selected, setSelected] = useState(null);
  const [hasVoted, setHasVoted] = useState(false);

  const voteKey = `presidentes_voted_${dni}`;
  const dataKey = `presidentes_votes_${dni}`;
  ...
  return (
    <div style={{ minHeight: "100vh", fontFamily: "'Roboto', system-ui, sans-serif" }}>
      ...
      <div className="container">
        ...
        {/* TÍTULO */}
        <h3 className="title">¿Por quién votarás como Presidente?</h3>
